import { c as convertToLadySpeak } from "./ai-BerxnPpc.js";
...
function Toaster() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ToastProvider, { children: [
    toasts.map(function({ id: id2, title, description, action, ...props }) {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(Toast, { ...props, className: "glass border-none", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ToastViewport, { className: "top-0 right-0 flex-col-reverse" })
  ] });
}
...
const Index = () => {
  ...
  const handleConvert = () => {
    const converted = convertToLadySpeak(input);
    setOutput(converted);
    toast2({
      title: "変換完了ですわ",
      description: "お嬢様言葉に変換いたしましたわ"
    });
  };
  const handleCopy = async () => {
    ...
    toast2({
      title: "コピー完了ですわ",
      description: "クリップボードにコピーいたしましたわ"
    });
    setTimeout(() => setCopied(false), 2e3);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-8 min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl md:text-5xl font-bold text-center mb-12 animate-fade-in text-[#7E69AB]", children: "お嬢様言葉変換器" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "textarea",
        {
          ...
          placeholder: "変換したい文章を入力してくださいませ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          className: "noble-button flex items-center gap-2 animate-scale-in",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(WandSparkles, { className: "w-5 h-5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "変換ですわ" })
          ]
        }
      ) }),
      output && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-fade-in", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glass rounded-lg p-4 min-h-[100px] whitespace-pre-wrap", children: output }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: handleCopy,
            className: "noble-button flex items-center gap-2",
            disabled: copied,
            children: copied ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-5 h-5" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "コピーできましたわ" })
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { className: "w-5 h-5" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "コピーですわ" })
            ] })
          }
        ) })
      ] })
...
const App = () => /* @__PURE__ */ jsxRuntimeExports.jsxs(TooltipProvider, { children: [
